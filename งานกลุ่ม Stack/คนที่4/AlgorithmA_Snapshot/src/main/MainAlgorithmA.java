...
import algorithms.TextEditorSnapshot;
import java.util.Scanner;

public class MainAlgorithmA {
    public static void main(String[] args) {
        TextEditorSnapshot editor = new TextEditorSnapshot();
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                default -> System.out.println("❌ Choice between 0 - 5");
            }
        }
        scanner.close();
    }
